...
const (
	...
	OrderServiceName = "lingmou.simple.sdk.order.api.OrderService"
)
...
const (
	...
	OrderServiceGetOrderProcedure = "/lingmou.simple.sdk.order.api.OrderService/GetOrder"
)
...
// OrderService is a client for the lingmou.simple.sdk.order.api.OrderService service.
type OrderService interface {
	GetOrder(ctx context.Context, req *GetOrderRequest, opts ...client.CallOption) (*GetOrderResponse, error)
}

// NewOrderService constructs a client for the api.OrderService service.
func NewOrderService(cli *client.Client, opts ...client.ReferenceOption) (OrderService, error) {
	conn, err := cli.DialWithInfo("lingmou.simple.sdk.order.api.OrderService", &OrderService_ClientInfo, opts...)
	if err != nil {
		return nil, err
	}
...
var OrderService_ClientInfo = client.ClientInfo{
	InterfaceName: "lingmou.simple.sdk.order.api.OrderService",
	MethodNames:   []string{"GetOrder"},
...
// OrderServiceHandler is an implementation of the lingmou.simple.sdk.order.api.OrderService service.
